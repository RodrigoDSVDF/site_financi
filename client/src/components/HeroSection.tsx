...
import { motion } from "framer-motion"; // Opcional: Recomendado para o "feel" moderno
    ...
    <section className="relative py-20 md:py-32 bg-background overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Área Visual (Mockup com Glassmorphism) */}
          <div className="relative group">
            {/* Moldura Flutuante */}
            <div className="absolute -inset-4 bg-gradient-to-tr from-primary/20 to-secondary/20 rounded-[40px] blur-2xl opacity-50 group-hover:opacity-80 transition-opacity duration-700"></div>
            ...
            <div className="relative z-10 p-3 bg-card/40 backdrop-blur-xl rounded-[32px] border border-white/10 shadow-2xl overflow-hidden">
              ...
              <img 
                ...
                className="w-full h-auto rounded-[24px] shadow-2xl transform transition-transform duration-700 group-hover:scale-[1.03]"
                loading="eager"
              />
            </div>

            {/* Floating Element - Detalhe de acabamento */}
            <div className="absolute -bottom-6 -right-6 bg-secondary p-4 rounded-2xl shadow-xl hidden md:block animate-bounce duration-[3000ms]">
