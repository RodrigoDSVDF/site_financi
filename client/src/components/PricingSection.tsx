    ...
    <section className="py-16 md:py-24 bg-gray-950">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          {/* Combo Price - Destaque com Link */}
          <div className="bg-gradient-to-br from-cyan-900/40 to-blue-900/40 p-6 rounded-lg shadow-xl border-4 border-cyan-500 relative flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="mb-6">
                <p className="text-2xl text-gray-500 line-through">R$ 157,90</p>
                <p className="text-4xl font-bold text-cyan-400 mb-2">R$ 9,90</p>
                <p className="text-sm text-gray-400">Oferta de lançamento</p>
              </div>
              <ul className="space-y-2 text-left text-sm text-gray-300 mb-6">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-green-400" />
